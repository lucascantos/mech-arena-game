...
export function drawHud(
  ...
  if (hud.possessed?.alive) {
    status = `Controlling ${hud.possessed.name}.  WASD move · Space dodge · Shift boost · Click fire · Right-click back unit · 1-4/wheel switch · R reload · Q lock-on · Tab stats · P release · V overview · C rotate`;
